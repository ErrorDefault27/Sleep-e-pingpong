...
0000000000001048 <copyinstr2>:
{
  ...
  if(pid == 0){
    ...
    10cc:	49878793          	addi	a5,a5,1176 # 8560 <big.1782>
    10d0:	00008697          	auipc	a3,0x8
    10d4:	49068693          	addi	a3,a3,1168 # 9560 <big.1782+0x1000>
      big[i] = 'x';
    ...
    10ea:	46078d23          	sb	zero,1146(a5) # 9560 <big.1782+0x1000>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    1cc0:	77f9                	lui	a5,0xffffe
    1cc2:	97ba                	add	a5,a5,a4
    1cc4:	0007c603          	lbu	a2,0(a5) # ffffffffffffe000 <base+0xfffffffffffef388>
    1cc8:	85a6                	mv	a1,s1
...
0000000000004214 <bigargtest>:
{
  ...
  close(fd);
    ...
    427c:	1e878793          	addi	a5,a5,488 # 8460 <args.2330>
    4280:	00004697          	auipc	a3,0x4
    4284:	2d868693          	addi	a3,a3,728 # 8558 <args.2330+0xf8>
      args[i] = big;
    ...
    4298:	1cc58593          	addi	a1,a1,460 # 8460 <args.2330>
